...
module.exports = function(app) {
    ...
    app.route('/users')
        .get(apiAuth, users.requiresLogin, users.list)
    ...
    app.route('/users/:userId')
        .get(apiAuth, users.requiresLogin, users.read)
        .put(apiAuth, users.requiresLogin, users.update)
        .delete(apiAuth, users.requiresLogin, users.delete);
